 ...
 */
export type MappingStrategy = "exact" | "fuzzy" | "historical_user" | "historical_org" | "historical";
/**
...
export type FileUploadImportConfig = CsvFileUploadImportConfig | JsonFileUploadImportConfig;
/**
 * Configuration for importing data, supporting various destination types.
 */
export type ImportConfig = WebhookImportConfig | LocalImportConfig | FileUploadImportConfig;
/**
 ...
 */
export declare enum OneSchemaLaunchError {
    MissingTemplate = 0,
    MissingJwt = 1,
 ...
 */
export type OneSchemaLaunchParamOptions = OneSchemaLaunchParams | OneSchemaLaunchSessionParams | OneSchemaLaunchTemplateGroupParams;
/**
 ...
 */
export type OneSchemaInitMessage = OneSchemaInitSimpleMessage | OneSchemaInitSessionMessage | OneSchemaInitTemplateGroupMessage;
/**
 * The default values for the OneSchema importer
 */
export declare const DEFAULT_PARAMS: Partial<OneSchemaParams>;
