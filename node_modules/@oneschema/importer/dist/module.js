...
(function (OneSchemaLaunchError) {
    OneSchemaLaunchError[OneSchemaLaunchError["MissingTemplate"] = 0] = "MissingTemplate";
    OneSchemaLaunchError[OneSchemaLaunchError["MissingJwt"] = 1] = "MissingJwt";
    OneSchemaLaunchError[OneSchemaLaunchError["MissingSessionToken"] = 2] = "MissingSessionToken";
    OneSchemaLaunchError[OneSchemaLaunchError["MissingTemplateGroup"] = 3] = "MissingTemplateGroup";
    OneSchemaLaunchError[OneSchemaLaunchError["LaunchError"] = 4] = "LaunchError";
...
class OneSchemaImporterClass extends eventemitter3.exports.EventEmitter {
    constructor(params) {
        ...
        _OneSchemaImporterClass_eventListener.set(this, (event) => {
            ...
            switch (event.data.messageType) {
                ...
                case "launched": {
                    ...
                    if (!sessionToken) {
                        sessionToken =
                            ((_c = this._initMessage) === null || _c === void 0 ? void 0 : _c.resumeToken) ||
                                ((_d = this._initMessage) === null || _d === void 0 ? void 0 : _d.sessionToken);
                    }
                    this.emit("launched", {
                        success: true,
                        sessionToken,
        ...
        __classPrivateFieldSet(this, _OneSchemaImporterClass_params, merge({}, DEFAULT_PARAMS, params), "f");
...
_a = OneSchemaImporterClass, _OneSchemaImporterClass_params = new WeakMap(), _OneSchemaImporterClass_eventListener = new WeakMap(), _OneSchemaImporterClass_instances = new WeakSet(), _OneSchemaImporterClass_hide = function _OneSchemaImporterClass_hide() {
    if (this.iframe) {
        this.iframe.style.display = "none";
    }
}, _OneSchemaImporterClass_show = function _OneSchemaImporterClass_show() {
    if (this.iframe) {
...
export { DEFAULT_PARAMS, OneSchemaImporterClass, OneSchemaLaunchError, oneSchemaImporter as default };
