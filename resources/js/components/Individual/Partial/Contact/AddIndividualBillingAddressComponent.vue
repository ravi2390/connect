    ...
    <v-card>
        ...
        <v-card-actions v-if="!readOnly && showSaveButton">
           <v-spacer></v-spacer>
            ...
            <v-btn v-if="!this.savedAddress" color="secondary" @click="saveNewAddress()" variant="elevated">Save and continue Adding...</v-btn>
            <v-btn color="success" @click="saveCloseAddress()" variant="elevated">{{ saveButtonLabel }}</v-btn>
        </v-card-actions>
    </v-card>
</template>
...
export default {
    ...
    watch: {
        individualBillingAddress: {
            handler (value) {
                // if (this.address && this.address.individualBillingAddressId === this.individualBillingAddress.individualBillingAddressId) {
                //     return;
                // }
                // this.individualBillingAddress = value;
