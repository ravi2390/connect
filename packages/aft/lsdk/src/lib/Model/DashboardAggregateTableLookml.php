 ...
 */
class DashboardAggregateTableLookml implements ModelInterface, ArrayAccess, \JsonSerializable, \Stringable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('aggregate_table_lookml', $data ?? [], null);
    }
    ...
    */
     ...
     * @return self
     */
    public function setAggregateTableLookml($aggregate_table_lookml): static
    {
        if (is_null($aggregate_table_lookml)) {
            array_push($this->openAPINullablesSetToNull, 'aggregate_table_lookml');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('aggregate_table_lookml', $nullablesSetToNull);
            if ($index !== false) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
