 ...
 */
class Theme implements ModelInterface, ArrayAccess, \JsonSerializable, \Stringable
{
    ...
    protected static $openAPITypes = [
        ...
        'id' => 'string',
        'name' => 'string',
        'settings' => \OpenAPI\Client\Model\ThemeSettings::class
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('begin_at', $data ?? [], null);
    ...
    */
     ...
     * @return self
     */
    public function setBeginAt($begin_at): static
    {
        if (is_null($begin_at)) {
            array_push($this->openAPINullablesSetToNull, 'begin_at');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('begin_at', $nullablesSetToNull);
            if ($index !== false) {
     ...
     * @return self
     */
    public function setEndAt($end_at): static
    {
        if (is_null($end_at)) {
