 ...
 */
class ApiSession implements ModelInterface, ArrayAccess, \JsonSerializable, \Stringable
{
    ...
    */
     ...
     * Sets sudo_user_id
     *
     * @param string|null $sudo_user_id The id of the actual user in the case when this session represents one user sudo'ing as another
     *
     * @return self
     */
