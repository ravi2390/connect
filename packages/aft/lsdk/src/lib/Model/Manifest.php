 ...
 */
class Manifest implements ModelInterface, ArrayAccess, \JsonSerializable, \Stringable
{
    ...
    protected static $openAPITypes = [
        ...
        'localization_settings' => \OpenAPI\Client\Model\LocalizationSettings::class
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('localization_settings', $data ?? [], null);
    }
    ...
    */
    ...
    {
        if (is_null($imports)) {
            array_push($this->openAPINullablesSetToNull, 'imports');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('imports', $nullablesSetToNull);
            if ($index !== false) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     * @return self
     */
    public function setLocalizationSettings($localization_settings): static
    {
        if (is_null($localization_settings)) {
            throw new \InvalidArgumentException('non-nullable localization_settings cannot be null');
        }
