 ...
 */
class ModelsNotValidated implements ModelInterface, ArrayAccess, \JsonSerializable, \Stringable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('project_file_id', $data ?? [], null);
    }
    ...
    */
     ...
     * @return self
     */
    public function setProjectFileId($project_file_id): static
    {
        if (is_null($project_file_id)) {
            array_push($this->openAPINullablesSetToNull, 'project_file_id');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('project_file_id', $nullablesSetToNull);
            if ($index !== false) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
