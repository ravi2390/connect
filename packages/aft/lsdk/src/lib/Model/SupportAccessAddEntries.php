 ...
 */
class SupportAccessAddEntries implements ModelInterface, ArrayAccess, \JsonSerializable, \Stringable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SupportAccessAddEntries';
    ...
    */
     ...
     * Sets emails
     *
     * @param string[]|null $emails An array of emails to add to the Allowlist
     *
     * @return self
     */
     ...
     * Sets reason
     *
     * @param string|null $reason Reason for adding emails to the Allowlist
     *
     * @return self
     */
