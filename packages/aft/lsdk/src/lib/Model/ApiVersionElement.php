 ...
 */
class ApiVersionElement implements ModelInterface, ArrayAccess, \JsonSerializable, \Stringable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('swagger_url', $data ?? [], null);
    }
    ...
    */
     ...
     * @return self
     */
    public function setFullVersion($full_version): static
    {
        if (is_null($full_version)) {
            array_push($this->openAPINullablesSetToNull, 'full_version');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('full_version', $nullablesSetToNull);
            if ($index !== false) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     * @return self
     */
    public function setSwaggerUrl($swagger_url): static
    {
        if (is_null($swagger_url)) {
            array_push($this->openAPINullablesSetToNull, 'swagger_url');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('swagger_url', $nullablesSetToNull);
            if ($index !== false) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
