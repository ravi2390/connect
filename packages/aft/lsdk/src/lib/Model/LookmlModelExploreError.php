 ...
 */
class LookmlModelExploreError implements ModelInterface, ArrayAccess, \JsonSerializable, \Stringable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('error_pos', $data ?? [], null);
        $this->setIfExists('field_error', $data ?? [], null);
    }
    ...
    */
     ...
     * @return self
     */
    public function setErrorPos($error_pos): static
    {
        if (is_null($error_pos)) {
            array_push($this->openAPINullablesSetToNull, 'error_pos');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('error_pos', $nullablesSetToNull);
            if ($index !== false) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     * @return self
     */
    public function setFieldError($field_error): static
    {
        if (is_null($field_error)) {
            throw new \InvalidArgumentException('non-nullable field_error cannot be null');
        }
