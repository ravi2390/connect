 ...
 */
class RepositoryCredential implements ModelInterface, ArrayAccess, \JsonSerializable, \Stringable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('root_project_id', $data ?? [], null);
    ...
    */
     ...
     * @return self
     */
    public function setRootProjectId($root_project_id): static
    {
        if (is_null($root_project_id)) {
            throw new \InvalidArgumentException('non-nullable root_project_id cannot be null');
        }
     ...
     * @return self
     */
    public function setRemoteUrl($remote_url): static
    {
     ...
     * @return self
     */
    public function setSshPublicKey($ssh_public_key): static
    {
        if (is_null($ssh_public_key)) {
            array_push($this->openAPINullablesSetToNull, 'ssh_public_key');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('ssh_public_key', $nullablesSetToNull);
            if ($index !== false) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     * @return self
     */
    public function setIsConfigured($is_configured): static
    {
