 ...
 */
class SmtpNodeStatus implements ModelInterface, ArrayAccess, \JsonSerializable, \Stringable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SmtpNodeStatus';
    ...
    */
     ...
     * Sets is_valid
     *
     * @param bool|null $is_valid SMTP status of node
     *
     * @return self
     */
     ...
     * Sets message
     *
     * @param string|null $message Error message for node
     *
     * @return self
     */
     ...
     * Sets hostname
     *
     * @param string|null $hostname Host name of node
     *
     * @return self
     */
