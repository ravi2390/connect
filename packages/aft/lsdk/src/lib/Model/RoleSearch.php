 ...
 */
class RoleSearch implements ModelInterface, ArrayAccess, \JsonSerializable, \Stringable
{
    ...
    protected static $openAPITypes = [
        ...
        'id' => 'string',
        'name' => 'string',
        'permission_set' => \OpenAPI\Client\Model\PermissionSet::class,
        'permission_set_id' => 'string',
        'model_set' => \OpenAPI\Client\Model\ModelSet::class,
        'model_set_id' => 'string',
        'user_count' => 'int',
        'url' => 'string',
        'users_url' => 'string'
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('permission_set', $data ?? [], null);
        $this->setIfExists('permission_set_id', $data ?? [], null);
        $this->setIfExists('model_set', $data ?? [], null);
        $this->setIfExists('model_set_id', $data ?? [], null);
    ...
    */
     ...
     * @return self
     */
    public function setPermissionSet($permission_set): static
    {
        if (is_null($permission_set)) {
            throw new \InvalidArgumentException('non-nullable permission_set cannot be null');
        }
     ...
     *
     * @param string|null $permission_set_id (Write-Only) Id of permission set
     *
     * @return self
     */
    public function setPermissionSetId($permission_set_id): static
    {
        if (is_null($permission_set_id)) {
            array_push($this->openAPINullablesSetToNull, 'permission_set_id');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('permission_set_id', $nullablesSetToNull);
            if ($index !== false) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     * @return self
     */
    public function setModelSet($model_set): static
    {
        if (is_null($model_set)) {
            throw new \InvalidArgumentException('non-nullable model_set cannot be null');
        }
     ...
     * Sets model_set_id
     *
     * @param string|null $model_set_id (Write-Only) Id of model set
     *
     * @return self
     */
    public function setModelSetId($model_set_id): static
    {
        if (is_null($model_set_id)) {
            array_push($this->openAPINullablesSetToNull, 'model_set_id');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('model_set_id', $nullablesSetToNull);
            if ($index !== false) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     * @return self
     */
    public function setUsersUrl($users_url): static
    {
        if (is_null($users_url)) {
            array_push($this->openAPINullablesSetToNull, 'users_url');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('users_url', $nullablesSetToNull);
            if ($index !== false) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
