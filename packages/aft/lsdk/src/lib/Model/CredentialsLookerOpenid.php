 ...
 */
class CredentialsLookerOpenid implements ModelInterface, ArrayAccess, \JsonSerializable, \Stringable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('logged_in_ip', $data ?? [], null);
    ...
    */
     ...
     * @return self
     */
    public function setLoggedInIp($logged_in_ip): static
    {
        if (is_null($logged_in_ip)) {
            array_push($this->openAPINullablesSetToNull, 'logged_in_ip');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('logged_in_ip', $nullablesSetToNull);
            if ($index !== false) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
