 ...
 */
class CredentialsSaml implements ModelInterface, ArrayAccess, \JsonSerializable, \Stringable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('saml_user_id', $data ?? [], null);
    ...
    */
     ...
     * @return self
     */
    public function setSamlUserId($saml_user_id): static
    {
        if (is_null($saml_user_id)) {
            array_push($this->openAPINullablesSetToNull, 'saml_user_id');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('saml_user_id', $nullablesSetToNull);
            if ($index !== false) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
