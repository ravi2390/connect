 ...
 */
class LookmlTest implements ModelInterface, ArrayAccess, \JsonSerializable, \Stringable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('explore_name', $data ?? [], null);
        $this->setIfExists('query_url_params', $data ?? [], null);
    ...
    */
     ...
     * @return self
     */
    public function setExploreName($explore_name): static
    {
        if (is_null($explore_name)) {
            throw new \InvalidArgumentException('non-nullable explore_name cannot be null');
        }
     ...
     * @return self
     */
    public function setQueryUrlParams($query_url_params): static
    {
        if (is_null($query_url_params)) {
            throw new \InvalidArgumentException('non-nullable query_url_params cannot be null');
        }
