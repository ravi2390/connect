 ...
 */
class CreateCredentialsApi3 implements ModelInterface, ArrayAccess, \JsonSerializable, \Stringable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateCredentialsApi3';
    ...
    */
     ...
     * Sets client_secret
     *
     * @param string|null $client_secret API key client_secret
     *
     * @return self
     */
