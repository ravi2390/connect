 ...
 */
class ContentValidationError implements ModelInterface, ArrayAccess, \JsonSerializable, \Stringable
{
    ...
    */
    ...
    public function setExploreName($explore_name): static
    {
        if (is_null($explore_name)) {
            array_push($this->openAPINullablesSetToNull, 'explore_name');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('explore_name', $nullablesSetToNull);
            if ($index !== false) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     * @return self
     */
    public function setRemovable($removable): static
    {
