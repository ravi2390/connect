 ...
 */
class SchemaColumn implements ModelInterface, ArrayAccess, \JsonSerializable, \Stringable
{
    ...
    protected static array $openAPINullables = [
        ...
        'schema_name' => true,
        'data_type_database' => false,
        'data_type' => false,
        'data_type_looker' => false,
        'description' => true,
        'column_size' => true,
        'snippets' => false
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('data_type_database', $data ?? [], null);
        $this->setIfExists('data_type', $data ?? [], null);
        $this->setIfExists('data_type_looker', $data ?? [], null);
        $this->setIfExists('description', $data ?? [], null);
        $this->setIfExists('column_size', $data ?? [], null);
    ...
    */
     ...
     * @return self
     */
    public function setDataTypeDatabase($data_type_database): static
    {
        if (is_null($data_type_database)) {
            throw new \InvalidArgumentException('non-nullable data_type_database cannot be null');
        }
     ...
     * @return self
     */
    public function setDataTypeLooker($data_type_looker): static
    {
        if (is_null($data_type_looker)) {
            throw new \InvalidArgumentException('non-nullable data_type_looker cannot be null');
        }
     ...
     * @return self
     */
    public function setColumnSize($column_size): static
    {
        if (is_null($column_size)) {
            array_push($this->openAPINullablesSetToNull, 'column_size');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('column_size', $nullablesSetToNull);
            if ($index !== false) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
