 ...
 */
class ContentSearch implements ModelInterface, ArrayAccess, \JsonSerializable, \Stringable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ContentSearch';
    ...
    */
     ...
     * Sets content_id
     *
     * @param string|null $content_id Primary id associated with the content
     *
     * @return self
     */
     ...
     * Sets type
     *
     * @param string|null $type Type of content
     *
     * @return self
     */
     ...
     * Sets folder_id
     *
     * @param string|null $folder_id Id of the folder where the content is saved
     *
     * @return self
     */
     ...
     * Sets folder_name
     *
     * @param string|null $folder_name Name of the folder where the content is saved
     *
     * @return self
     */
    public function setFolderName($folder_name): static
    {
        if (is_null($folder_name)) {
            array_push($this->openAPINullablesSetToNull, 'folder_name');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('folder_name', $nullablesSetToNull);
            if ($index !== false) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     * Sets view_count
     *
     * @param int|null $view_count Number of times the content has been viewed
     *
     * @return self
     */
     ...
     *
     * @param string|null $preferred_viewer Preferred way of viewing the content (only applies to dashboards)
     *
     * @return self
     */
