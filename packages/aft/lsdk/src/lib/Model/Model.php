 ...
 */
class Model implements ModelInterface, ArrayAccess, \JsonSerializable, \Stringable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('value_formats', $data ?? [], null);
    }
    ...
    */
     ...
     * @return self
     */
    public function setValueFormats($value_formats): static
    {
        if (is_null($value_formats)) {
            array_push($this->openAPINullablesSetToNull, 'value_formats');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('value_formats', $nullablesSetToNull);
            if ($index !== false) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
