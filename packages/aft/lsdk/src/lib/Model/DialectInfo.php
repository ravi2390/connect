 ...
 */
class DialectInfo implements ModelInterface, ArrayAccess, \JsonSerializable, \Stringable
{
    ...
    protected static $openAPITypes = [
        ...
        'label_for_schema_equivalent' => 'string',
        'name' => 'string',
        'supported_options' => \OpenAPI\Client\Model\DialectInfoOptions::class
    ];
    ...
    protected static $openAPIFormats = [
        ...
        'label_for_schema_equivalent' => null,
        'name' => null,
    ...
    protected static array $openAPINullables = [
        'can' => false,
        'default_max_connections' => true,
        'default_port' => true,
        'installed' => false,
        'label' => true,
        'label_for_database_equivalent' => true,
        'label_for_schema_equivalent' => true,
        'name' => true,
    ...
    protected static $attributeMap = [
        ...
        'label_for_schema_equivalent' => 'label_for_schema_equivalent',
        'name' => 'name',
    ...
    protected static $setters = [
        ...
        'label_for_schema_equivalent' => 'setLabelForSchemaEquivalent',
        'name' => 'setName',
    ...
    protected static $getters = [
        ...
        'label_for_schema_equivalent' => 'getLabelForSchemaEquivalent',
        'name' => 'getName',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('default_max_connections', $data ?? [], null);
        $this->setIfExists('default_port', $data ?? [], null);
        $this->setIfExists('installed', $data ?? [], null);
        $this->setIfExists('label', $data ?? [], null);
        $this->setIfExists('label_for_database_equivalent', $data ?? [], null);
        $this->setIfExists('label_for_schema_equivalent', $data ?? [], null);
        $this->setIfExists('name', $data ?? [], null);
        $this->setIfExists('supported_options', $data ?? [], null);
    }
    ...
    */
     ...
     * @return self
     */
    public function setDefaultMaxConnections($default_max_connections): static
    {
        if (is_null($default_max_connections)) {
            array_push($this->openAPINullablesSetToNull, 'default_max_connections');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('default_max_connections', $nullablesSetToNull);
            if ($index !== false) {
     ...
     * @return self
     */
    public function setDefaultPort($default_port): static
    {
        if (is_null($default_port)) {
            array_push($this->openAPINullablesSetToNull, 'default_port');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('default_port', $nullablesSetToNull);
            if ($index !== false) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     * @return self
     */
    public function setInstalled($installed): static
    {
     ...
     * @return self
     */
    public function setLabelForDatabaseEquivalent($label_for_database_equivalent): static
    {
        if (is_null($label_for_database_equivalent)) {
            array_push($this->openAPINullablesSetToNull, 'label_for_database_equivalent');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('label_for_database_equivalent', $nullablesSetToNull);
            if ($index !== false) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
    ...
    /**
     * Gets label_for_schema_equivalent
     *
     * @return string|null
     */
    public function getLabelForSchemaEquivalent()
    {
        return $this->container['label_for_schema_equivalent'];
    }

    /**
     * Sets label_for_schema_equivalent
     *
     * @param string|null $label_for_schema_equivalent What the dialect calls the equivalent of a schema-level namespace
     *
     * @return self
     */
    public function setLabelForSchemaEquivalent($label_for_schema_equivalent): static
    {
        if (is_null($label_for_schema_equivalent)) {
            array_push($this->openAPINullablesSetToNull, 'label_for_schema_equivalent');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('label_for_schema_equivalent', $nullablesSetToNull);
            if ($index !== false) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['label_for_schema_equivalent'] = $label_for_schema_equivalent;
     ...
     * @return self
     */
    public function setSupportedOptions($supported_options): static
    {
        if (is_null($supported_options)) {
            throw new \InvalidArgumentException('non-nullable supported_options cannot be null');
        }
