 ...
 */
class CredentialsGoogle implements ModelInterface, ArrayAccess, \JsonSerializable, \Stringable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('google_user_id', $data ?? [], null);
    ...
    */
     ...
     * @return self
     */
    public function setGoogleUserId($google_user_id): static
    {
        if (is_null($google_user_id)) {
            array_push($this->openAPINullablesSetToNull, 'google_user_id');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('google_user_id', $nullablesSetToNull);
            if ($index !== false) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
