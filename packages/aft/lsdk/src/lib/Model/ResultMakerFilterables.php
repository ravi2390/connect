 ...
 */
class ResultMakerFilterables implements ModelInterface, ArrayAccess, \JsonSerializable, \Stringable
{
    ...
    */
    ...
    {
        if (is_null($view)) {
            array_push($this->openAPINullablesSetToNull, 'view');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('view', $nullablesSetToNull);
            if ($index !== false) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     * @return self
     */
    public function setListen($listen): static
    {
        if (is_null($listen)) {
            array_push($this->openAPINullablesSetToNull, 'listen');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('listen', $nullablesSetToNull);
            if ($index !== false) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
