...
class Folder implements ModelInterface, ArrayAccess, \JsonSerializable, \Stringable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('looks', $data ?? [], null);
    }
    ...
    */
     ...
     * @return self
     */
    public function setDashboards($dashboards): static
    {
        if (is_null($dashboards)) {
            array_push($this->openAPINullablesSetToNull, 'dashboards');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('dashboards', $nullablesSetToNull);
            if ($index !== false) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     * @return self
     */
    public function setLooks($looks): static
    {
        if (is_null($looks)) {
            array_push($this->openAPINullablesSetToNull, 'looks');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('looks', $nullablesSetToNull);
            if ($index !== false) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
