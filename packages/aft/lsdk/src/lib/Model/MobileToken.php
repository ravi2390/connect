 ...
 */
class MobileToken implements ModelInterface, ArrayAccess, \JsonSerializable, \Stringable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MobileToken';
     ...
     * @return string[]
     */
    public function getDeviceTypeAllowableValues(): array
    {
        return [
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('device_token', $data ?? [], null);
    ...
    */
     ...
     * @return self
     */
    public function setDeviceToken($device_token): static
    {
        if (is_null($device_token)) {
            throw new \InvalidArgumentException('non-nullable device_token cannot be null');
        }
     ...
     * @return self
     */
    public function setDeviceType($device_type): static
    {
