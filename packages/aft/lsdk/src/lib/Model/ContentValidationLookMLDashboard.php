 ...
 */
class ContentValidationLookMLDashboard implements ModelInterface, ArrayAccess, \JsonSerializable, \Stringable
{
    ...
    */
     ...
     * @return self
     */
    public function setSpaceId($space_id): static
    {
        if (is_null($space_id)) {
            array_push($this->openAPINullablesSetToNull, 'space_id');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('space_id', $nullablesSetToNull);
            if ($index !== false) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
