...
/**
 * SqlInterfaceQueryMetadata Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class SqlInterfaceQueryMetadata implements ModelInterface, ArrayAccess, \JsonSerializable, \Stringable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SqlInterfaceQueryMetadata';
    ...
    */
     ...
     * Sets results
     *
     * @param string|null $results JDBC Metadata to inflate Avatica response classes.
     *
     * @return self
     */
