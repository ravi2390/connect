 ...
 */
class EmbedCookielessSessionAcquire implements ModelInterface, ArrayAccess, \JsonSerializable, \Stringable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'EmbedCookielessSessionAcquire';
    ...
    */
     ...
     * Sets embed_domain
     *
     * @param string|null $embed_domain The domain of the server embedding the Looker IFRAME. This is an alternative to specifying the domain in the embedded domain allow list in the Looker embed admin page.
     *
     * @return self
     */
     ...
     *
     * @param string|null $session_reference_token Token referencing the embed session and is used to generate new authentication, navigation and api tokens.
     *
     * @return self
     */
