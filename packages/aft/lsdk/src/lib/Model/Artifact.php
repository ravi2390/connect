 ...
 */
class Artifact implements ModelInterface, ArrayAccess, \JsonSerializable, \Stringable
{
    ...
    protected static array $openAPINullables = [
        ...
        'updated_at' => false,
        'value_size' => false,
        'created_by_userid' => false,
        'updated_by_userid' => false
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('created_by_userid', $data ?? [], null);
        $this->setIfExists('updated_by_userid', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets content_type
     *
     * @param string|null $content_type MIME type of content. This can only be used to override content that is detected as text/plain. Needed to set application/json content types, which are analyzed as plain text.
     *
     * @return self
     */
     ...
     * Sets version
     *
     * @param int|null $version Version number of the stored value. The version must be provided for any updates to an existing artifact.
     *
     * @return self
     */
     ...
     * @return self
     */
    public function setValueSize($value_size): static
    {
     ...
     * @return self
     */
    public function setCreatedByUserid($created_by_userid): static
    {
        if (is_null($created_by_userid)) {
            throw new \InvalidArgumentException('non-nullable created_by_userid cannot be null');
        }
     ...
     * @return self
     */
    public function setUpdatedByUserid($updated_by_userid): static
    {
        if (is_null($updated_by_userid)) {
            throw new \InvalidArgumentException('non-nullable updated_by_userid cannot be null');
        }
