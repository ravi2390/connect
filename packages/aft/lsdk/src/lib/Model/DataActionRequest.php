 ...
 */
class DataActionRequest implements ModelInterface, ArrayAccess, \JsonSerializable, \Stringable
{
    ...
    */
     ...
     * @return self
     */
    public function setFormValues($form_values): static
    {
        if (is_null($form_values)) {
            array_push($this->openAPINullablesSetToNull, 'form_values');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('form_values', $nullablesSetToNull);
            if ($index !== false) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
