 ...
 */
class DashboardAppearance implements ModelInterface, ArrayAccess, \JsonSerializable, \Stringable
{
    ...
    protected static array $openAPINullables = [
        'page_side_margins' => true,
        'page_background_color' => true,
        'tile_title_alignment' => true,
        'tile_space_between' => true,
    ...
    */
     ...
     * @return self
     */
    public function setPageSideMargins($page_side_margins): static
    {
        if (is_null($page_side_margins)) {
            array_push($this->openAPINullablesSetToNull, 'page_side_margins');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('page_side_margins', $nullablesSetToNull);
            if ($index !== false) {
     ...
     * @return self
     */
    public function setPageBackgroundColor($page_background_color): static
    {
        if (is_null($page_background_color)) {
            array_push($this->openAPINullablesSetToNull, 'page_background_color');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('page_background_color', $nullablesSetToNull);
            if ($index !== false) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
    ...
    public function setTileTitleAlignment($tile_title_alignment): static
    {
        if (is_null($tile_title_alignment)) {
            array_push($this->openAPINullablesSetToNull, 'tile_title_alignment');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('tile_title_alignment', $nullablesSetToNull);
            if ($index !== false) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     * @return self
     */
    public function setTileSpaceBetween($tile_space_between): static
    {
        if (is_null($tile_space_between)) {
            array_push($this->openAPINullablesSetToNull, 'tile_space_between');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('tile_space_between', $nullablesSetToNull);
            if ($index !== false) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
    ...
    public function setTileShadow($tile_shadow): static
    {
        if (is_null($tile_shadow)) {
            array_push($this->openAPINullablesSetToNull, 'tile_shadow');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('tile_shadow', $nullablesSetToNull);
            if ($index !== false) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     * @return self
     */
    public function setKeyColor($key_color): static
    {
        if (is_null($key_color)) {
            array_push($this->openAPINullablesSetToNull, 'key_color');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('key_color', $nullablesSetToNull);
            if ($index !== false) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
