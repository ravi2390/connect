 ...
 */
class IntegrationRequiredField implements ModelInterface, ArrayAccess, \JsonSerializable, \Stringable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('any_tag', $data ?? [], null);
    ...
    */
     ...
     * Sets any_tag
     *
     * @param string[]|null $any_tag If present, supersedes 'tag' and matches a field that has any of the provided tags.
     *
     * @return self
     */
    public function setAnyTag($any_tag): static
    {
        if (is_null($any_tag)) {
            array_push($this->openAPINullablesSetToNull, 'any_tag');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('any_tag', $nullablesSetToNull);
            if ($index !== false) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     * Sets all_tags
     *
     * @param string[]|null $all_tags If present, supersedes 'tag' and matches a field that has all of the provided tags.
     *
     * @return self
     */
    public function setAllTags($all_tags): static
    {
        if (is_null($all_tags)) {
            array_push($this->openAPINullablesSetToNull, 'all_tags');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('all_tags', $nullablesSetToNull);
            if ($index !== false) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
