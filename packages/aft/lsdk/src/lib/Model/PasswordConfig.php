 ...
 */
class PasswordConfig implements ModelInterface, ArrayAccess, \JsonSerializable, \Stringable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('require_numeric', $data ?? [], null);
        $this->setIfExists('require_upperlower', $data ?? [], null);
        $this->setIfExists('require_special', $data ?? [], null);
    }
    ...
    */
     ...
     * @return self
     */
    public function setMinLength($min_length): static
    {
     ...
     * @return self
     */
    public function setRequireNumeric($require_numeric): static
    {
        if (is_null($require_numeric)) {
            throw new \InvalidArgumentException('non-nullable require_numeric cannot be null');
        }
     ...
     * @return self
     */
    public function setRequireUpperlower($require_upperlower): static
    {
        if (is_null($require_upperlower)) {
            throw new \InvalidArgumentException('non-nullable require_upperlower cannot be null');
        }
     ...
     * @return self
     */
    public function setRequireSpecial($require_special): static
    {
        if (is_null($require_special)) {
            throw new \InvalidArgumentException('non-nullable require_special cannot be null');
        }
