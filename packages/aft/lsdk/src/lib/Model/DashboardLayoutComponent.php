 ...
 */
class DashboardLayoutComponent implements ModelInterface, ArrayAccess, \JsonSerializable, \Stringable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('dashboard_layout_id', $data ?? [], null);
        ...
        $this->setIfExists('element_title', $data ?? [], null);
        $this->setIfExists('element_title_hidden', $data ?? [], null);
        $this->setIfExists('vis_type', $data ?? [], null);
    }
    ...
    */
     ...
     * @return self
     */
    public function setDashboardLayoutId($dashboard_layout_id): static
    {
        if (is_null($dashboard_layout_id)) {
            array_push($this->openAPINullablesSetToNull, 'dashboard_layout_id');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('dashboard_layout_id', $nullablesSetToNull);
            if ($index !== false) {
     ...
     * @return self
     */
    public function setElementTitle($element_title): static
    {
        if (is_null($element_title)) {
            array_push($this->openAPINullablesSetToNull, 'element_title');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('element_title', $nullablesSetToNull);
            if ($index !== false) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     * @return self
     */
    public function setElementTitleHidden($element_title_hidden): static
    {
        if (is_null($element_title_hidden)) {
            throw new \InvalidArgumentException('non-nullable element_title_hidden cannot be null');
        }
     ...
     * @return self
     */
    public function setVisType($vis_type): static
    {
        if (is_null($vis_type)) {
            array_push($this->openAPINullablesSetToNull, 'vis_type');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('vis_type', $nullablesSetToNull);
            if ($index !== false) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
