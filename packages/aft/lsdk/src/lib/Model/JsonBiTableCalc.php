...
/**
 * JsonBiTableCalc Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class JsonBiTableCalc implements ModelInterface, ArrayAccess, \JsonSerializable, \Stringable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'JsonBiTableCalc';
    ...
    */
    ...
    public function listInvalidProperties(): array
    {
        ...
        if ($this->container['value_format'] === null) {
            $invalidProperties[] = "'value_format' can't be null";
        }
     ...
     * Sets name
     *
     * @param string $name Table Calc Name
     *
     * @return self
     */
     ...
     * Sets label
     *
     * @param string $label Table Calc Label
     *
     * @return self
     */
     ...
     * Sets expression
     *
     * @param string $expression Evaluated table calculation expression
     *
     * @return self
     */
     ...
     * Sets value_format
     *
     * @param string $value_format Value format
     *
     * @return self
     */
     ...
     * Sets measure
     *
     * @param bool $measure If table calculation is a measure
     *
     * @return self
     */
    public function setMeasure($measure): static
    {
        if (is_null($measure)) {
            ...
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('measure', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
