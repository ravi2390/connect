 ...
 */
class InternalHelpResourcesContent implements ModelInterface, ArrayAccess, \JsonSerializable, \Stringable
{
    ...
    */
     ...
     * @return self
     */
    public function setOrganizationName($organization_name): static
    {
     ...
     * @return self
     */
    public function setMarkdownContent($markdown_content): static
    {
        if (is_null($markdown_content)) {
            array_push($this->openAPINullablesSetToNull, 'markdown_content');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('markdown_content', $nullablesSetToNull);
            if ($index !== false) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
