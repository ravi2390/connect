 ...
 */
class AlertNotifications implements ModelInterface, ArrayAccess, \JsonSerializable, \Stringable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AlertNotifications';
    ...
    protected static $openAPITypes = [
        ...
        'ran_at' => 'string',
        'alert' => \OpenAPI\Client\Model\MobilePayload::class
    ];
    ...
    */
     ...
     *
     * @param string|null $notification_id ID of the notification
     *
     * @return self
     */
    public function setNotificationId($notification_id): static
    {
     ...
     *
     * @param string|null $alert_condition_id ID of the alert
     *
     * @return self
     */
    public function setAlertConditionId($alert_condition_id): static
    {
        if (is_null($alert_condition_id)) {
            throw new \InvalidArgumentException('non-nullable alert_condition_id cannot be null');
        }
     ...
     * Sets is_read
     *
     * @param bool|null $is_read Read state of the notification
     *
     * @return self
     */
    public function setIsRead($is_read): static
    {
        if (is_null($is_read)) {
     ...
     * Sets field_value
     *
     * @param float|null $field_value The value of the field on which the alert condition is set
     *
     * @return self
     */
    public function setFieldValue($field_value): static
    {
     ...
     *
     * @param float|null $threshold_value The value of the threshold which triggers the alert notification
     *
     * @return self
     */
    public function setThresholdValue($threshold_value): static
    {
        if (is_null($threshold_value)) {
            array_push($this->openAPINullablesSetToNull, 'threshold_value');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('threshold_value', $nullablesSetToNull);
            if ($index !== false) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     * Sets ran_at
     *
     * @param string|null $ran_at The time at which the alert query ran
     *
     * @return self
     */
    public function setRanAt($ran_at): static
    {
        if (is_null($ran_at)) {
            throw new \InvalidArgumentException('non-nullable ran_at cannot be null');
        }
     ...
     * Gets alert
     *
     * @return \OpenAPI\Client\Model\MobilePayload|null
     */
     ...
     * Sets alert
     *
     * @param \OpenAPI\Client\Model\MobilePayload|null $alert alert
     *
     * @return self
     */
