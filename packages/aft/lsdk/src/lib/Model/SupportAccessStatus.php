 ...
 */
class SupportAccessStatus implements ModelInterface, ArrayAccess, \JsonSerializable, \Stringable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SupportAccessStatus';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('open_until', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets open
     *
     * @param bool|null $open Whether or not Support Access is open
     *
     * @return self
     */
    public function setOpen($open): static
    {
        if (is_null($open)) {
     ...
     * Sets open_until
     *
     * @param \DateTime|null $open_until Time that Support Access will expire
     *
     * @return self
     */
    public function setOpenUntil($open_until): static
    {
        if (is_null($open_until)) {
            array_push($this->openAPINullablesSetToNull, 'open_until');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('open_until', $nullablesSetToNull);
            if ($index !== false) {
