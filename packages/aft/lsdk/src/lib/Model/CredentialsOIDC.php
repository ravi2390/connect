 ...
 */
class CredentialsOIDC implements ModelInterface, ArrayAccess, \JsonSerializable, \Stringable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('oidc_user_id', $data ?? [], null);
    ...
    */
     ...
     * @return self
     */
    public function setOidcUserId($oidc_user_id): static
    {
        if (is_null($oidc_user_id)) {
            array_push($this->openAPINullablesSetToNull, 'oidc_user_id');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('oidc_user_id', $nullablesSetToNull);
            if ($index !== false) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
