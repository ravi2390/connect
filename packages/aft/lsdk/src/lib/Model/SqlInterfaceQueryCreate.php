...
/**
 * SqlInterfaceQueryCreate Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class SqlInterfaceQueryCreate implements ModelInterface, ArrayAccess, \JsonSerializable, \Stringable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SqlInterfaceQueryCreate';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('jdbc_client', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets sql
     *
     * @param string $sql Original SQL request
     *
     * @return self
     */
     ...
     * @return bool|null
     */
    public function getJdbcClient()
    {
        return $this->container['jdbc_client'];
    }

    /**
     * Sets jdbc_client
     *
     * @param bool|null $jdbc_client Whether the query should be run for use in a JDBC Client. This changes the formatting of some datetime based values.
     *
     * @return self
     */
    public function setJdbcClient($jdbc_client): static
    {
        if (is_null($jdbc_client)) {
            throw new \InvalidArgumentException('non-nullable jdbc_client cannot be null');
        }
        $this->container['jdbc_client'] = $jdbc_client;
