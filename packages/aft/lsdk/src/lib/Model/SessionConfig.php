 ...
 */
class SessionConfig implements ModelInterface, ArrayAccess, \JsonSerializable, \Stringable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('allow_persistent_sessions', $data ?? [], null);
        $this->setIfExists('session_minutes', $data ?? [], null);
        $this->setIfExists('unlimited_sessions_per_user', $data ?? [], null);
        $this->setIfExists('use_inactivity_based_logout', $data ?? [], null);
        $this->setIfExists('track_session_location', $data ?? [], null);
    }
    ...
    */
     ...
     * @return self
     */
    public function setAllowPersistentSessions($allow_persistent_sessions): static
    {
        if (is_null($allow_persistent_sessions)) {
            throw new \InvalidArgumentException('non-nullable allow_persistent_sessions cannot be null');
        }
     ...
     * @return self
     */
    public function setSessionMinutes($session_minutes): static
    {
        if (is_null($session_minutes)) {
            array_push($this->openAPINullablesSetToNull, 'session_minutes');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('session_minutes', $nullablesSetToNull);
            if ($index !== false) {
     ...
     * @return self
     */
    public function setUnlimitedSessionsPerUser($unlimited_sessions_per_user): static
    {
        if (is_null($unlimited_sessions_per_user)) {
            throw new \InvalidArgumentException('non-nullable unlimited_sessions_per_user cannot be null');
        }
     ...
     * @return self
     */
    public function setUseInactivityBasedLogout($use_inactivity_based_logout): static
    {
        if (is_null($use_inactivity_based_logout)) {
            throw new \InvalidArgumentException('non-nullable use_inactivity_based_logout cannot be null');
        }
     ...
     * @return self
     */
    public function setTrackSessionLocation($track_session_location): static
    {
        if (is_null($track_session_location)) {
            throw new \InvalidArgumentException('non-nullable track_session_location cannot be null');
        }
