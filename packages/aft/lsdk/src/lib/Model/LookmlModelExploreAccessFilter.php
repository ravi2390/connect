 ...
 */
class LookmlModelExploreAccessFilter implements ModelInterface, ArrayAccess, \JsonSerializable, \Stringable
{
    ...
    */
     ...
     * @return self
     */
    public function setUserAttribute($user_attribute): static
    {
        if (is_null($user_attribute)) {
            array_push($this->openAPINullablesSetToNull, 'user_attribute');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('user_attribute', $nullablesSetToNull);
            if ($index !== false) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
