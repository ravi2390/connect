 ...
 */
class DashboardLookml implements ModelInterface, ArrayAccess, \JsonSerializable, \Stringable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('lookml', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets folder_id
     *
     * @param string|null $folder_id (Write-Only) Id of the folder
     *
     * @return self
     */
     ...
     * @return self
     */
    public function setLookml($lookml): static
    {
        if (is_null($lookml)) {
            array_push($this->openAPINullablesSetToNull, 'lookml');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('lookml', $nullablesSetToNull);
            if ($index !== false) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
