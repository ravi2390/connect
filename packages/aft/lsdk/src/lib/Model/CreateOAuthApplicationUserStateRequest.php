 ...
 */
class CreateOAuthApplicationUserStateRequest implements ModelInterface, ArrayAccess, \JsonSerializable, \Stringable
{
    ...
    */
    ...
    public function setOauthApplicationId($oauth_application_id): static
    {
        if (is_null($oauth_application_id)) {
            throw new \InvalidArgumentException('non-nullable oauth_application_id cannot be null');
        }
     ...
     * @return self
     */
    public function setAccessTokenExpiresAt($access_token_expires_at): static
    {
     ...
     * @return self
     */
    public function setRefreshTokenExpiresAt($refresh_token_expires_at): static
    {
        if (is_null($refresh_token_expires_at)) {
            array_push($this->openAPINullablesSetToNull, 'refresh_token_expires_at');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('refresh_token_expires_at', $nullablesSetToNull);
            if ($index !== false) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
