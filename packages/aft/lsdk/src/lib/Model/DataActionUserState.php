 ...
 */
class DataActionUserState implements ModelInterface, ArrayAccess, \JsonSerializable, \Stringable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('refresh_time', $data ?? [], null);
    }
    ...
    */
     ...
     * @return self
     */
    public function setRefreshTime($refresh_time): static
    {
        if (is_null($refresh_time)) {
            array_push($this->openAPINullablesSetToNull, 'refresh_time');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('refresh_time', $nullablesSetToNull);
            if ($index !== false) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
