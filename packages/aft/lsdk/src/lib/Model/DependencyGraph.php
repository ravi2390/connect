 ...
 */
class DependencyGraph implements ModelInterface, ArrayAccess, \JsonSerializable, \Stringable
{
    ...
    {
        $this->setIfExists('graph_text', $data ?? [], null);
    }
    ...
    */
     ...
     * @return self
     */
    public function setGraphText($graph_text): static
    {
        if (is_null($graph_text)) {
            throw new \InvalidArgumentException('non-nullable graph_text cannot be null');
        }
