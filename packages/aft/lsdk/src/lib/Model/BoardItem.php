 ...
 */
class BoardItem implements ModelInterface, ArrayAccess, \JsonSerializable, \Stringable
{
    ...
    */
     ...
     *
     * @param string|null $board_section_id Associated Board Section
     *
     * @return self
     */
    public function setBoardSectionId($board_section_id): static
    {
