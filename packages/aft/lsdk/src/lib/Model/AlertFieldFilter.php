 ...
 */
class AlertFieldFilter implements ModelInterface, ArrayAccess, \JsonSerializable, \Stringable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AlertFieldFilter';
    ...
    */
     ...
     * Sets field_value
     *
     * @param Any $field_value Field Value. Depends on the type of field - numeric or string. For [location](https://cloud.google.com/looker/docs/reference/field-reference/dimension-type-reference#location) type, it's a list of floats. Example `[1.0, 56.0]`
     *
     * @return self
     */
     ...
     * Sets filter_value
     *
     * @param string|null $filter_value Filter Value. Usually null except for [location](https://cloud.google.com/looker/docs/reference/field-reference/dimension-type-reference#location) type. It'll be a string of lat,long ie `'1.0,56.0'`
     *
     * @return self
     */
    public function setFilterValue($filter_value): static
    {
        if (is_null($filter_value)) {
            ...
            $index = array_search('filter_value', $nullablesSetToNull);
            if ($index !== false) {
