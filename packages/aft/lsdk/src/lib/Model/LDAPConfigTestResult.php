 ...
 */
class LDAPConfigTestResult implements ModelInterface, ArrayAccess, \JsonSerializable, \Stringable
{
    ...
    protected static $openAPITypes = [
        ...
        'status' => 'string',
        'trace' => 'string',
        'user' => \OpenAPI\Client\Model\LDAPUser::class,
        'url' => 'string'
    ];
    ...
    */
     ...
     * @return self
     */
    public function setIssues($issues): static
    {
        if (is_null($issues)) {
