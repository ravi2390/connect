 ...
 */
class CostEstimate implements ModelInterface, ArrayAccess, \JsonSerializable, \Stringable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('cost_unit', $data ?? [], null);
    ...
    */
     ...
     * @return self
     */
    public function setCacheHit($cache_hit): static
    {
     ...
     * @return self
     */
    public function setCostUnit($cost_unit): static
    {
        if (is_null($cost_unit)) {
            throw new \InvalidArgumentException('non-nullable cost_unit cannot be null');
        }
