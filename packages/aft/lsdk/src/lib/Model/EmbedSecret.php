 ...
 */
class EmbedSecret implements ModelInterface, ArrayAccess, \JsonSerializable, \Stringable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'EmbedSecret';
    ...
    public const SECRET_TYPE_SSO = 'SSO';
    public const SECRET_TYPE_JWT = 'JWT';
     ...
     * @return string[]
     */
    public function getSecretTypeAllowableValues(): array
    {
        return [
            self::SECRET_TYPE_SSO,
            self::SECRET_TYPE_JWT,
        ];
    }
    ...
    */
    ...
    public function listInvalidProperties(): array
    {
        ...
        if (!is_null($this->container['secret_type']) && !in_array($this->container['secret_type'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'secret_type', must be one of '%s'",
                $this->container['secret_type'],
     ...
     * Sets algorithm
     *
     * @param string|null $algorithm Signing algorithm to use with this secret. Either `hmac/sha-256`(default) or `hmac/sha-1`
     *
     * @return self
     */
     ...
     * Sets created_at
     *
     * @param string|null $created_at When secret was created
     *
     * @return self
     */
     ...
     * Sets enabled
     *
     * @param bool|null $enabled Is this secret currently enabled
     *
     * @return self
     */
     ...
     * Sets secret
     *
     * @param string|null $secret Secret for use with SSO embedding
     *
     * @return self
     */
     ...
     * Sets user_id
     *
     * @param string|null $user_id Id of user who created this secret
     *
     * @return self
     */
     ...
     * Sets secret_type
     *
     * @param string|null $secret_type Field to distinguish between SSO secrets and JWT secrets Valid values are: \"SSO\", \"JWT\".
     *
     * @return self
     */
    public function setSecretType($secret_type): static
    {
