...
/**
 * LookmlFieldLink Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class LookmlFieldLink implements ModelInterface, ArrayAccess, \JsonSerializable, \Stringable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'LookmlFieldLink';
    ...
    */
     ...
     * Sets label
     *
     * @param string|null $label The name of the link as it would appear to users.
     *
     * @return self
     */
     ...
     * Sets url
     *
     * @param string|null $url URL the link will go to.
     *
     * @return self
     */
     ...
     * Sets icon_url
     *
     * @param string|null $icon_url A URL containing an image file to display with a link.
     *
     * @return self
     */
