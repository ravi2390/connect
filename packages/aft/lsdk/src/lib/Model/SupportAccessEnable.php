 ...
 */
class SupportAccessEnable implements ModelInterface, ArrayAccess, \JsonSerializable, \Stringable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SupportAccessEnable';
    ...
    {
        $this->setIfExists('duration_in_seconds', $data ?? [], null);
    }
    ...
    */
     ...
     * @return self
     */
    public function setDurationInSeconds($duration_in_seconds): static
    {
        if (is_null($duration_in_seconds)) {
            array_push($this->openAPINullablesSetToNull, 'duration_in_seconds');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('duration_in_seconds', $nullablesSetToNull);
            if ($index !== false) {
