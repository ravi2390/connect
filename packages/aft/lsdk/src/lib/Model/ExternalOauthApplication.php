 ...
 */
class ExternalOauthApplication implements ModelInterface, ArrayAccess, \JsonSerializable, \Stringable
{
    ...
    */
     ...
     * Sets id
     *
     * @param string|null $id ID of this OAuth Application
     *
     * @return self
     */
     ...
     * Sets tenant_id
     *
     * @param string|null $tenant_id The OAuth Tenant ID for this application
     *
     * @return self
     */
    public function setTenantId($tenant_id): static
    {
