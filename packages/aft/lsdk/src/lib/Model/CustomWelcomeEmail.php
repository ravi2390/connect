 ...
 */
class CustomWelcomeEmail implements ModelInterface, ArrayAccess, \JsonSerializable, \Stringable
{
    ...
    */
     ...
     * Sets subject
     *
     * @param string|null $subject The text to appear in the email subject line. Only available with a whitelabel license and whitelabel_configuration.advanced_custom_welcome_email enabled.
     *
     * @return self
     */
     ...
     * Sets header
     *
     * @param string|null $header The text to appear in the header line of the email body. Only available with a whitelabel license and whitelabel_configuration.advanced_custom_welcome_email enabled.
     *
     * @return self
     */
