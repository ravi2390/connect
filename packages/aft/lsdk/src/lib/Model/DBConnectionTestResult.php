 ...
 */
class DBConnectionTestResult implements ModelInterface, ArrayAccess, \JsonSerializable, \Stringable
{
    ...
    */
     ...
     * @return self
     */
    public function setConnectionString($connection_string): static
    {
