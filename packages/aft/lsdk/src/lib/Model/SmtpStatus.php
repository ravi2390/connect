 ...
 */
class SmtpStatus implements ModelInterface, ArrayAccess, \JsonSerializable, \Stringable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SmtpStatus';
    ...
    protected static $openAPITypes = [
        'is_valid' => 'bool',
        'node_count' => 'int',
        'node_status' => '\OpenAPI\Client\Model\SmtpNodeStatus[]'
    ];
    ...
    */
     ...
     * Sets is_valid
     *
     * @param bool|null $is_valid Overall SMTP status of cluster
     *
     * @return self
     */
    public function setIsValid($is_valid): static
    {
        if (is_null($is_valid)) {
     ...
     * Sets node_count
     *
     * @param int|null $node_count Total number of nodes in cluster
     *
     * @return self
     */
    public function setNodeCount($node_count): static
    {
        if (is_null($node_count)) {
            array_push($this->openAPINullablesSetToNull, 'node_count');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('node_count', $nullablesSetToNull);
            if ($index !== false) {
     ...
     * Gets node_status
     *
     * @return \OpenAPI\Client\Model\SmtpNodeStatus[]|null
     */
     ...
     * Sets node_status
     *
     * @param \OpenAPI\Client\Model\SmtpNodeStatus[]|null $node_status array of each node's status containing is_valid, message, hostname
     *
     * @return self
     */
    public function setNodeStatus($node_status): static
    {
        if (is_null($node_status)) {
            array_push($this->openAPINullablesSetToNull, 'node_status');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('node_status', $nullablesSetToNull);
            if ($index !== false) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
